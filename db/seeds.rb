...
Professional.create(nombre: 'Ramiro Cruz', telefono: 34021258, profesion_u_oficio: 'Carpintero', servicios_ofrecidos: 'Carpintero, Construcción, Mantenimiento')
Professional.create(nombre: 'Jaime Ortega', telefono: 5248796, profesion_u_oficio: 'plomero', servicios_ofrecidos: 'Construcción, Electricidad, Plomerìa')
Professional.create(nombre: 'Alberto Martinez', telefono: 7581245, profesion_u_oficio: 'Electricista, pintor', servicios_ofrecidos: 'Construcción, Electricidad, Plomería')
Professional.create(nombre: 'Carlos Gómez', telefono: 7457821, profesion_u_oficio: 'Cerrajero', servicios_ofrecidos: 'Electricidad, Cerrajería')
Professional.create(nombre: 'David Rodriguez', telefono: 4521554, profesion_u_oficio: 'Cerrajero', servicios_ofrecidos: 'Electricidad, Cerrajería')
Professional.create(nombre: 'José Palomino', telefono: 7457823, profesion_u_oficio: 'Electricista, Pintor', servicios_ofrecidos: 'Construcción, Electricidad, Plomerìa')
